<%-- 
    Document   : productos
    Created on : 22-jul-2019, 1:02:41
    Author     : TOBAR
--%>
...
<%
    ...
    ArrayList<Producto> listaP = pro.listaProductosl();
        ...
        <div class="content-wrapper" style="min-height: 1741px;">
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="../ControlProducto.do" method="POST">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="txtPrecio">Percio</label>
                                    <input type="number" class="form-control"  name="txtPrecio" placeholder="Precio" required>
                                </div>
                                <div class="col-lg-6">
                                    <label for="txtConfirmaContra">Canidad Existencia</label>
                                    <input type="text" class="form-control"  name="txtCatidad" placeholder="Catidad">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="selTipo">Categoria</label>
                                    <select class="form-control" name="selCategoria">
                                        <% for (Categoria_Producto cp : listaCP) {%>
                    ...
                    <div class="box-body">
                        <div class="Val-Table" >
                            <table id="dataTable" class="display table" style="width:100%">
                                ...
                                <%
                                    for (Producto pr : listaP) {
                                %>
                                <tr>
                                    <td>
                                        <div class='row ValAcc'>
                                            <div class='col-xs-12 Val-UDP'>
                                                <a onclick="cargarform(<%=pr.getId()%>, '<%=pr.getNombre()%>', '<%=pr.getDescripcio()%>', '<%=pr.getPrecio()%>',<%=pr.getCantidad()%>, '<%=pr.getCategoria()%>', '<%=pr.getImagen()%>', '<%=pr.getEstado()%>');"  href="#nuevo" class='btn btn-info btn-sm'  data-toggle="modal"  >
                                                    <span class='glyphicon glyphicon-wrench'></span></a> 
                                                <a class='btn btn-danger btn-sm' id='btnEliminar'
                                                   href="../ControlProducto.do?accion=eliminar&id=<%=pr.getId()%>"><span
                                                        class='glyphicon glyphicon-remove'></span></a> </div>
                                        </div>
                                    </td>
                                    <th><%=pr.getNombre()%></th>
                                    <th><%=pr.getDescripcio()%></th>
                                    <th><%=pr.getPrecio()%></th>
                                    <th><%=pr.getCantidad()%></th>
                                    <th><%=pr.getCategoria()%></th>
                                    <th><%=pr.getImagen()%></th>
                                    <th><%=pr.getEstado()%></th>
                                </tr>
                                <%}%>
                        ...
                        <div id="nuevo" class="modal animated bounceIn fullscreen-modal" tabindex="-1"  role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="../ControlProducto.do"  method="Post" name="Update">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6 ">
                                                    ...
                                                    <select class="form-control" id="selImagen" name="selImagen">
                                                        <% for (Imagen obj : listaImg) {%>
                                                        <option style="background-image :url('../resources/img/<%=obj.getUrl()%>') no-repeat center left; padding-left:20px;"  value="<%=obj.getId()%>">  </option>
                                                        <%}%>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6 "> 
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    <label for="txtPrecio">Percio</label>
                                                    <input type="number" class="form-control"   id="txtPrecio" name="txtPrecio" placeholder="Precio" required>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label for="txtConfirmaContra">Canidad Existencia</label>
                                                    <input type="text" class="form-control" id="txtCatidad"   name="txtCatidad" placeholder="Catidad">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-6">
...
<script src="../resources/js/mantenimientos/productos.js"></script> 
</body>
